 ...
 */
package spring.driver.dependency_injection.collection_dtd.properties;
...
public class PropertiesDriver {
    public static void main(String[] args) {
        Resource resource = new ClassPathResource("/spring/driver/dependency_injection/collection_dtd/properties/configuration.xml");
