 ...
 */
package spring.driver.life_cycle_implementation.default_init_destroy_approach;
...
public class DriverJDBCDao {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("/spring/driver/life_cycle_implementation/default_init_destroy_approach/configuration.xml");
